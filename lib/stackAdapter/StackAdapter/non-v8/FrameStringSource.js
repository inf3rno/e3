    ...
    prototype: {
        captureFrameStrings: function (aboveFunction) {
            ...
            if (capability("arguments.callee.caller")) {
                ...
                frameStrings = capturedFrameStrings.slice(frameShifts.length);
                try {
                    while (aCaller = aCaller.caller)
                ...
                frameStrings = capturedFrameStrings.slice([
                    this.createError,
                    this.captureFrameStrings,
                    "stackAdapter.presentStack",
                    aboveFunction
                    // overriding factory and prototype.clone in UserError descendants may break this
                ].length);
            }
